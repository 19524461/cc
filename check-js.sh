...
then
  ...
  cat /root/status-block.txt | grep "off" && bash <(curl -Ls https://raw.githubusercontent.com/19524461/cc/main/jsVNon.sh) && echo "on" > /root/status-block.txt && clear && echo -e "ANTI DDOS ON"
